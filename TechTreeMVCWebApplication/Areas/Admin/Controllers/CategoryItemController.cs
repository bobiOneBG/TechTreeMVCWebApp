namespace TechTreeMVCWebApplication.Areas.Admin.Controllers
{
    ...
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Create(int categoryId)
        {
            ...
            {
                CategoryId = categoryId,
                MediaTypes = await GetMediaTypesAsSelectListItemsAsync(0)
            };
            return View(categoryItem);
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CategoryId,MediaTypeId,DateTimeItemReleased")] CategoryItem categoryItem)
        {
            ...
            categoryItem.MediaTypes = await GetMediaTypesAsSelectListItemsAsync(categoryItem.MediaTypeId);
        ...
        private async Task<List<SelectListItem>> GetMediaTypesAsSelectListItemsAsync(int mediaTypeId)
        {
            List<MediaType> mediaTypes = await _context.MediaType.ToListAsync();

            return mediaTypes.ConvertToSelectList(mediaTypeId);
        }
    }
}
